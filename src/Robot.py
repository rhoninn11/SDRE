...
class Robot:
    ...
    def setup_simulation(self):
        ...
        x1 = sp.Matrix([sp.Function('x11')(self.t), sp.Function('x12')(self.t), sp.Function('x13')(self.t)])
        x2 = x1_prim = sp.Matrix([sp.Function('x21')(self.t), sp.Function('x22')(self.t), sp.Function('x23')(self.t)])
        M_obliczeniowa = 0
        C_obliczeniowa = 0
        G_obliczeniowa = 0
        ...
        #
        return symulacja(M_obliczeniowa, C_obliczeniowa, G_obliczeniowa, x1, x2)
